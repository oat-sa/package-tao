    ...
    */
    ...
    public function editDelivery()
    {
        ...
        if (!is_null($compiled)) {
            ...
            // history stats:
            $count = 0;
            foreach (taoDelivery_models_classes_CompilationService::singleton()->getAllCompilations($delivery) as $c) {
                $count += taoDelivery_models_classes_DeliveryExecutionService::singleton()->getDeliveryExecutionCount($c);
            }
            $this->setData("executionNumber", $count);
        }
