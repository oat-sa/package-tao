 ...
 */
class taoQTI_models_classes_QTI_ResponseDeclaration extends taoQTI_models_classes_QTI_VariableDeclaration
{
    ...
    public function addFeedbackRule(taoQTI_models_classes_QTI_response_SimpleFeedbackRule $simpleFeedbackRule){
