 ...
 */
class taoQTI_models_classes_QTI_container_ContainerInteractive extends taoQTI_models_classes_QTI_container_Container
{
	...
	public function getValidElementTypes(){
		return array(
			...
			'taoQTI_models_classes_QTI_interaction_Interaction'
		);
	}
...
} /* end of class taoQTI_models_classes_QTI_container_ContainerInteractive */