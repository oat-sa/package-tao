 ...
 */
class taoQTI_models_classes_QTI_feedback_ModalFeedback extends taoQTI_models_classes_QTI_feedback_Feedback
{
    ...
    public function toForm(){
        $formContainer = new taoQTI_actions_QTIform_ModalFeedback($this);
