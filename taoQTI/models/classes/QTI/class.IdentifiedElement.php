 ...
 */
abstract class taoQTI_models_classes_QTI_IdentifiedElement extends taoQTI_models_classes_QTI_Element
{
    ...
    protected function generateIdentifier($prefix = ''){
        ...
        $relatedItem = $this->getRelatedItem();
        if(is_null($relatedItem)){
            throw new taoQTI_models_classes_QTI_QtiModelException('cannot generate the identifier because the element does not belong to any item');
        }
...
/* end of abstract class taoQTI_models_classes_QTI_IdentifiedElement */