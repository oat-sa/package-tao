 ...
 */
class taoQTI_models_classes_QTI_datatype_Identifier extends taoQTI_models_classes_QTI_datatype_Datatype
{
	 ...
	 * 
	 * @param taoQTI_models_classes_QTI_IdentifiedElement $value
	 * @return boolean
	 */
	...
	public static function getAllowedClasses(){
		return array(
			'taoQTI_models_classes_QTI_IdentifiedElement'
		);
	}
...
} /* end of class taoQTI_models_classes_QTI_datatype_Identifier */