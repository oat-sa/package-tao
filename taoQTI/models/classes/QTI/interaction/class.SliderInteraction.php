 ...
 */
class taoQTI_models_classes_QTI_interaction_SliderInteraction extends taoQTI_models_classes_QTI_interaction_BlockInteraction
{
    ...
    protected function getUsedAttributes(){
        return array_merge(
            ...
            'taoQTI_models_classes_QTI_attribute_LowerBoundSliderInteraction',
            'taoQTI_models_classes_QTI_attribute_UpperBoundSliderInteraction',
            'taoQTI_models_classes_QTI_attribute_Step',
            'taoQTI_models_classes_QTI_attribute_StepLabel',
            'taoQTI_models_classes_QTI_attribute_Orientation',
            'taoQTI_models_classes_QTI_attribute_Reverse'
                )
        );
    }
