 ...
 */
class taoQTI_models_classes_QTI_interaction_Prompt extends taoQTI_models_classes_QTI_Element implements taoQTI_models_classes_QTI_container_FlowContainer
{
    ...
    public function __construct($attributes = array(), taoQTI_models_classes_QTI_Item $relatedItem = null, $serial = ''){
        ...
        $this->body = new taoQTI_models_classes_QTI_container_ContainerStatic('', $relatedItem);
    }
    ...
    public function toXHTML(){
        return '<p class="prompt">'.$this->body->toXHTML().'</p>';
    }
