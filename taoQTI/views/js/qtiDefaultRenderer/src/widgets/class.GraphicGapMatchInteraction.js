QtiWidget.DefaultWidget.GraphicGapMatchInteraction = QtiWidget.DefaultWidget.GraphicInteraction.extend({
    ...
    createArea : function(imageWidth, imageHeight){
        ...
        for(var choiceId in ctx.options.graphicChoices){
            ...
            if(currentHotSpotShape && currentHotSpotCoords){
                ...
                QtiWidget.DefaultWidget.setDeactivatedShapeAttr(currentShape);
    ...
    fillGap : function(hotspotId, gapImgId){
        ...
        if(_hotspotMatchMax == 0 || _hotspotCurrent < _hotspotMatchMax){
            ...
            QtiWidget.DefaultWidget.animateForbiddenShape(raphShape);
            return false
        }

        //ok, set response : 
        QtiWidget.DefaultWidget.animateAllowedShape(raphShape);
        ...
        var gapCenter = QtiWidget.DefaultWidget.getShapeCenter(raphShape);
        $('#' + ctx.id + ' #' + filledId).css({
