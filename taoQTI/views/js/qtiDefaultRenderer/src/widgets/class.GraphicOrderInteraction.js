QtiWidget.DefaultWidget.GraphicOrderInteraction = QtiWidget.DefaultWidget.GraphicInteraction.extend({
    countChoices : 0,
    shapes : [],
    orderedElements : [],
    paper : null,
    ...
    setOrder : function(number, choiceId){
        ...
        if(ctx.orderedElements[choiceId].state === "empty" && number > 0){
            ...
            QtiWidget.DefaultWidget.setActivatedShapeAttr();
            var coords = QtiWidget.DefaultWidget.getShapeCenter(currentShape);
            ...
            QtiWidget.DefaultWidget.setDeactivatedShapeAttr(currentShape, 400);
