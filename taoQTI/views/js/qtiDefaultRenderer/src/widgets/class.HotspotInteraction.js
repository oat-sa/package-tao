QtiWidget.DefaultWidget.HotspotInteraction = QtiWidget.DefaultWidget.GraphicInteraction.extend({
    countChoices : 0,
    shapes : [],
    paper : null,
    render : function(){
    ...
    select : function(choiceId){
        ...
        if(responseIndex >= 0){
            this.countChoices -= 1;
            QtiWidget.DefaultWidget.setDeactivatedShapeAttr(this.shapes[choiceId]);
            ...
            this.countChoices += 1;
            QtiWidget.DefaultWidget.setActivatedShapeAttr(this.shapes[choiceId]);
            this.paper.safari();
