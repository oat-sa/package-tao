QtiWidget = {};
QtiWidget.DefaultWidget = {};
QtiWidget.DefaultWidget.Widget = Class.extend({
    init : function(interaction, context){
        ...
        this.resultCollector = new QTIResultCollector(interaction);
    },
    render : function(){
 ...
 * @returns {Object}
 */
QtiWidget.DefaultWidget.getShapeCenter = function(raphaelShape){
 ...
 * @returns {Array}
 */
QtiWidget.DefaultWidget.polyCoordonates = function(path){
    ...
    for(var a = 1; a < pathArrayLength; a++){
        if(QtiWidget.DefaultWidget.isPair(a)){
 ...
 * @returns {Number}
 */
QtiWidget.DefaultWidget.isPair = function(number){
    return (!number % 2);
};
 ...
 */
QtiWidget.DefaultWidget.setDeactivatedShapeAttr = function(raphaelShape, animationDuration){
 ...
 * @param raphaelShape
 */
QtiWidget.DefaultWidget.setActivatedShapeAttr = function(raphaelShape){
    if(raphaelShape && raphaelShape.animate){
        raphaelShape.animate({
            'fill' : 'green',
            'fill-opacity' : .2,
 ...
 * @param raphaelShape
 */
QtiWidget.DefaultWidget.setForbiddenShapeAttr = function(raphaelShape){
 ...
 * @param raphaelShape
 */
QtiWidget.DefaultWidget.animateForbiddenShape = function(raphaelShape){
    QtiWidget.DefaultWidget.setForbiddenShapeAttr(raphaelShape);
    setTimeout(function(){
        QtiWidget.DefaultWidget.setDeactivatedShapeAttr(raphaelShape, 400);
    }, 400);
};
 ...
 * @param raphaelShape
 */
QtiWidget.DefaultWidget.animateAllowedShape = function(raphaelShape){
    QtiWidget.DefaultWidget.setActivatedShapeAttr(raphaelShape);
    setTimeout(function(){
        QtiWidget.DefaultWidget.setDeactivatedShapeAttr(raphaelShape, 400);
    }, 400);
};