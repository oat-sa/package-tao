QtiWidget.DefaultWidget.MediaInteraction = QtiWidget.DefaultWidget.Widget.extend({
    init : function(interaction, context){
        ...
        this.objectWidget = new QtiWidget.DefaultWidget.Object(interaction.getObject(), context);
    },
    render : function(){
