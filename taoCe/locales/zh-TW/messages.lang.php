...
$GLOBALS['__l10n']["Default properties of the test-takers are their name and the language of the test interface. You can customize these records by adding any data you need, such as date of birth, gender, etc."]="考生的預設屬性是他們的名字和測試界面的語言。你可以通過加入你所需要的任何數據，如出生日期，性別，等等來定制這些記錄。";
