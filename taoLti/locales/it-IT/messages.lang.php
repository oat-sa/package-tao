...
$GLOBALS['__l10n']["Learning Tools Interoperability"]="Strumenti di apprendimento ";
...
$GLOBALS['__l10n']["Open in a new window"]="Apri in nuova finestra";
...
$GLOBALS['__l10n']["Return to %s."]="Torna a ";
...
$GLOBALS['__l10n']["Server Error"]="Errore del server";
...
$GLOBALS['__l10n']["The LTI connection could not be established"]="La connessione a LTI non può essere stabilita";
$GLOBALS['__l10n']["The LTI Provider library."]="Raccolta di Provider LTI";
$GLOBALS['__l10n']["The LTI tool could not be opened in the current window. Please click on the button to open it in a new window."]="Lo strumento LTI non può essere aperto nella finestra corrente. Si prega di premere il bottone per visualizzarlo in una nuova finestra";
...
$GLOBALS['__l10n']["Third party cookies are not supported by your browser"]="I cookies da terze parti non sono supportati dal tuo browser";
...
$GLOBALS['__l10n']["Unable to restore Session"]="Impossibile ripristinare la sessione";
...
$GLOBALS['__l10n']["You are not authorized to use this system"]="Non sei autorizzato ad usare questo sistema";
