module.exports = function(grunt) {
    ...
    var testRunners = root + '/taoTests/views/js/test/**/test.html';
    var testFiles = root + '/taoTests/views/js/test/**/test.js';
    ...
    // bundle task
    grunt.registerTask('taoteststest', ['qunit:taotests']);
};
