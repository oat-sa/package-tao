...
/**
 * Importhandler for APIP packages
 *
 * @access public
 * @author Jérôme Bogaerts <joel@taotesting.com>
 * @package taoQTIItem
 
 */
class ApipPackageImport implements tao_models_classes_import_ImportHandler
{
    ...
    public function getForm() {
    	$form = new ApipPackageImportForm();
    	return $form->getForm();
    }
    ...
    public function import($class, $form) {
        ...
        if (isset($fileInfo['uploaded_file'])) {
			...
			try {
				...
				$report = $importService->importQTIPACKFile($uploadedFile, $class, true, $repository, $rollbackOnError, $rollbackOnWarning, true);
			} catch (ExtractException $e) {
			    $report = common_report_Report::createFailure(__('The ZIP archive containing the IMS APIP Item cannot be extracted.'));
		        ...
		        $report = common_report_Report::createFailure(__("An unexpected error occured during the import of the IMS APIP Item Package."));
			}
