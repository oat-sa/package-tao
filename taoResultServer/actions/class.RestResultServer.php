 ...
 */
class taoResultServer_actions_RestResultServer extends tao_actions_CommonRestModule
{
    ...
    public function __construct()
    {
        ...
        $this->service = taoResultServer_models_classes_CrudResultServerService::singleton();
    }
    ...
    protected function getParametersAliases()
    {
        return array_merge(parent::getParametersAliases(), array(
            "model" => TAO_RESULTSERVER_MODEL_PROP
        )
        );
    }
