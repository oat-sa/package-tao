...
class ResContainer extends ResResource 
{
	...
	*
	...
	function add($object)
	{
		...
		if(!$this->hasProperty(new ResResource(_RDF_NAMESPACE_URI._RDF_TYPE)))
			$this->addProperty(new ResResource(_RDF_NAMESPACE_URI._RDF_TYPE),$this->containerType);
		//get the current size
		$actualSize=$this->size();
		//add the object to the last position
		$this->addProperty(new ResResource(_RDF_NAMESPACE_URI.'_'.($actualSize+1)),$object);
	}
	...
	*
	...
	function isAlt()
	{
		return ($this->containerType->getURI()==_RDF_NAMESPACE_URI._RDF_ALT);
	}
	...
	*
	...
	function isBag()
	{
		return ($this->containerType->getURI()==_RDF_NAMESPACE_URI._RDF_BAG);
	}
	...
	*
	...
	function isSeq()
	{
		return ($this->containerType->getURI()==_RDF_NAMESPACE_URI._RDF_SEQ);
	}
	...
	*
	...
	{
		return substr($predicateLabel,0,strlen(_RDF_NAMESPACE_URI.'_')) == _RDF_NAMESPACE_URI.'_';
	}
	...
	*
	...
	{
		return (int)substr($predicateLabel,strlen(_RDF_NAMESPACE_URI.'_'));
	}
	...
	*
	...
	{
		return new ResResource(_RDF_NAMESPACE_URI.'_'.$int);	
	}
}
?>
