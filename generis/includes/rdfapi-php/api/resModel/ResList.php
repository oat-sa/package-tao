...
class ResList extends ResResource 
{
    ...
    */		
	function ResList($uri = null)
	{
		...
		//initialize vars
		$this->rdfRestResource = new ResResource(_RDF_NAMESPACE_URI._RDF_REST);
		$this->rdfFirstResource = new ResResource(_RDF_NAMESPACE_URI._RDF_FIRST);
		$this->rdfNilResource = new ResResource(_RDF_NAMESPACE_URI._RDF_NIL);
	}
	...
	*
	...
	function add($resource)
	{
		...
		if($this->uri==_RDF_NAMESPACE_URI._RDF_NIL)
			return false;
	...
	*
	...
	function removeList()
	{
		...
		while ($element!==null)
		{
			...
			if (($nextElement !== null) && ($nextElement->getURI()!==_RDF_NAMESPACE_URI._RDF_NIL))
			{
				$element=$nextElement;
			} else 
			{
	...
	*
	...
	function isValid()
	{
		...
		do 
		{
			...
			if ($element->getURI() == _RDF_NAMESPACE_URI._RDF_NIL)
				return true;
