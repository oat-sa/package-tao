...
class Statement extends Object {
  ...
  function & reify(&$model_or_bNodeID) {
		...
		$RDFstatement = new Resource(_RDF_NAMESPACE_URI . _RDF_STATEMENT);
		$RDFtype = new Resource(_RDF_NAMESPACE_URI . _RDF_TYPE);
		$RDFsubject = new Resource(_RDF_NAMESPACE_URI . _RDF_SUBJECT);
		$RDFpredicate = new Resource(_RDF_NAMESPACE_URI . _RDF_PREDICATE);
		$RDFobject = new Resource(_RDF_NAMESPACE_URI . _RDF_OBJECT);
