...
$GLOBALS['__l10n']["# Collected Results"]="# Resultados colhidos";
$GLOBALS['__l10n']["# Collected Score Variables"]="# Pontuações Variáveis Colhidas";
$GLOBALS['__l10n']["# data collected"]="# dados colhidos";
$GLOBALS['__l10n']["# Distinct Test Takers"]="# Examinado distinto";
$GLOBALS['__l10n']["# Distinct variable types"]="# Tipos de variáveis distintas";
...
$GLOBALS['__l10n']["Add All grades"]="Adicionar todos os anos";
$GLOBALS['__l10n']["Add All responses"]="Adicionar todas as respostas";
...
$GLOBALS['__l10n']["Add Test Taker"]="Adicionar examinado";
...
$GLOBALS['__l10n']["All results of passed Tests with their referring Subject, Group and Item specific data, as well as the individual data collected during Test execution are stored and managed here."]="Todos os resultados dos testes realizados  com o assunto referindo-se, Grupo e dados específicos do item, bem como os dados individuais colhidos durante a execução do teste são armazenados e geridos aqui";
...
$GLOBALS['__l10n']["Anonymise"]="Anónimos";
...
$GLOBALS['__l10n']["Collected Results"]="Colher resultados";
...
$GLOBALS['__l10n']["custom table"]="Tabela personalizada";
$GLOBALS['__l10n']["Data Collection per Variable"]="Colher informação por variaveis";
$GLOBALS['__l10n']["Data collection statistics :"]="Estatísticas da informação colhida:";
...
$GLOBALS['__l10n']["Delivery"]="Distribuir";
$GLOBALS['__l10n']["Delivery Result"]="Resultado da distribuição";
$GLOBALS['__l10n']["Delivery results"]="Resultados da distribuição";
...
$GLOBALS['__l10n']["Edit result class"]="Editar resultados da disciplina";
...
$GLOBALS['__l10n']["Frequency per Score"]="Frequência de pontuações";
...
$GLOBALS['__l10n']["Observed performances per distinc score variable types "]="Performances observadas por tipos de variáveis distintos";
...
$GLOBALS['__l10n']["Print Report"]="Imprime relatório";
...
$GLOBALS['__l10n']["Remove All grades"]="Remover todos os anos";
$GLOBALS['__l10n']["Remove All responses"]="Remover todas as respostas";
...
$GLOBALS['__l10n']["Report generated from the following subset of results : "]="Relatório gerado pelos seguintes sub-conjuntos de resultados:";
...
$GLOBALS['__l10n']["Results distribution"]="Distribuição de resultados";
$GLOBALS['__l10n']["Results library"]="Biblioteca de resultados";
$GLOBALS['__l10n']["Results Selection Filters"]="Filtro de seleção de resultados";
...
$GLOBALS['__l10n']["score average"]="pontuação media";
$GLOBALS['__l10n']["Score average per Variable"]="Pontuação media por variável";
$GLOBALS['__l10n']["Score per Observation"]="Pontuação por observação";
$GLOBALS['__l10n']["Scores and response rates statistics"]="Estatística de Respostas e pontuações";
...
$GLOBALS['__l10n']["The class you have selected contains no results to be analysed, please select a different class"]="Os anos que seleccionou não contem resultados para serem analisados, por favor seleccione outro ano";
...
$GLOBALS['__l10n']["The number of observations is too low"]="O numero de observações é demasiado baixo";
...
$GLOBALS['__l10n']["There was a problem generating your report, please try again."]="Houve um problema a gerar este relatório, por favor tente de novo.";
...
$GLOBALS['__l10n']["Total Standard Deviation"]="Desvio total normal";
...
$GLOBALS['__l10n']["VariableName"]="Nome da variável";
...
$GLOBALS['__l10n']["We are preparing your report, please wait..."]="Estamos a preparar o ser relatório, por favor aguarde...";
